...
namespace RetailerApp
{
    public class CustomNavigationPage : NavigationPage
    {
        ...
        //public static readonly BindableProperty TitleFont = BindableProperty.CreateAttached("TitleFont", typeof(Font), typeof(CustomNavigationPage), Font.SystemFontOfSize(NamedSize.Medium));
        //public static TitleAlignment GetTitleFont(BindableObject view)
        //{

        //    return (TitleAlignment)view.GetValue(TitleFont);

        //}

        //public static void SetTitleFont(BindableObject view, TitleAlignment value)
        //{
        //    view.SetValue(TitleFont, value);
        //}
        ...
        public static readonly BindableProperty TitleFontProperty = BindableProperty.CreateAttached("TitleFont", typeof(Font), typeof(CustomNavigationPage), Font.SystemFontOfSize(NamedSize.Large));
