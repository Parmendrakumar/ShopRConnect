    ...
    public class CustomNavigationPageRenderer : NavigationPageRenderer
    {
        ...
        private void LastPage_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            else if (e.PropertyName == CustomPage.FormattedTitleProperty.PropertyName && (lastPage is CustomPage))
            {
                ...
                {
                    _subTitleTextView.TextFormatted = cPage.FormattedSubtitle.ToAttributed(Xamarin.Forms.Font.Default, Xamarin.Forms.Color.Default, _subTitleTextView);
        ...
        void UpdateFormattedTitleText(AppCompatTextView titleTextView, FormattedString formattedString, string defaulTitle)
        {
            ...
            {
                titleTextView.TextFormatted = formattedString.ToAttributed(Xamarin.Forms.Font.Default, Xamarin.Forms.Color.Default, titleTextView);
            }
            else
            {
        ...
        void UpdateToolbarSubtitle(CustomPage cPage, AppCompatTextView subTitleTextView, Typeface originalFont, ColorStateList defaultColorStateList)
        {
            ...
            if (cPage.FormattedSubtitle != null && cPage.FormattedSubtitle.Spans.Count > 0)
            {
                subTitleTextView.TextFormatted = cPage.FormattedSubtitle.ToAttributed(Xamarin.Forms.Font.Default, Xamarin.Forms.Color.Default, _subTitleTextView);
